...
mm_inverse_kinematics::mm_inverse_kinematics() {
  ...
  base_link_to_agv_matrix(2, 3) = 0.393;
}

bool mm_inverse_kinematics::getIkFromPose(geometry_msgs::Pose pose, std::vector<double> agv_joint_values,
                                          std::vector<double>& joint_values) {
  joint_values.clear();

  Eigen::Affine3d ee_link_to_base_link_matrix, rg2_to_world_matrix;
  tf2::convert(pose, rg2_to_world_matrix);
  ee_link_to_base_link_matrix = base_link_to_agv_matrix.inverse() * rg2_to_world_matrix;
