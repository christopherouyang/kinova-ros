...
namespace mm_motion_planner
{
    ...
    /******************************插值函数******************************/
    bool mm_motion_planner::cartesionInter(geometry_msgs::Pose start_pose, geometry_msgs::Pose target_pose, std::vector<std::vector<double> >& pose_vector)
    {
    ...
    void mm_motion_planner::linearInter(geometry_msgs::Pose start_pose, geometry_msgs::Pose target_pose, std::vector<geometry_msgs::Pose>& way_point_pose)
    {
    ...
    void mm_motion_planner::orientationInter(geometry_msgs::Pose start_pose, geometry_msgs::Pose target_pose, std::vector<geometry_msgs::Pose>& way_point_pose)
    {
    ...
    void mm_motion_planner::positionInter(geometry_msgs::Pose start_pose, geometry_msgs::Pose target_pose, std::vector<geometry_msgs::Pose>& way_point_pose)
    {
