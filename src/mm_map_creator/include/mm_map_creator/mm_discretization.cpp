...
octomap::OcTree* mm_discretization::generateBoxTree(const octomap::point3d origin, double max_range,
                                                    double resolution) {
...
octomap::OcTree* mm_discretization::generateRotationTree(const octomap::point3d origin, double max_range,
                                                         double resolution) {
  octomap::OcTree* tree = new octomap::OcTree(resolution / 2);
  octomap::Pointcloud p;
